...
conn.reply(m.chat, `${mid.buscador9}\n\n` + res.result.isi, fkontak, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝐆𝐞𝐫𝐚𝐥 𝐁𝐨𝐭 | 𝙒𝙞𝙠𝙞𝙥𝙚𝙙𝙞𝙖', body: '𝐆𝐞𝐫𝐚𝐥 𝐁𝐨𝐭 💙👨🏻‍💻', previewType: 0, thumbnail: imagen2, sourceUrl: accountsgb }}})
}).catch((e) => {
